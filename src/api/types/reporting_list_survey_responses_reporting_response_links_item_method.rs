...
pub enum ListSurveyResponsesReportingResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSurveyResponsesReportingResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSurveyResponsesReportingResponseLinksItemMethod {
...
impl fmt::Display for ListSurveyResponsesReportingResponseLinksItemMethod {
