...
pub enum ListAutomationsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAutomationsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAutomationsResponseLinksItemMethod {
...
impl fmt::Display for ListAutomationsResponseLinksItemMethod {
