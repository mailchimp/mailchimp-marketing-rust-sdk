...
pub enum ListRootResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListRootResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListRootResponseLinksItemMethod {
...
impl fmt::Display for ListRootResponseLinksItemMethod {
