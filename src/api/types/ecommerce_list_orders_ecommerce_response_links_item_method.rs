...
pub enum ListOrdersEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListOrdersEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListOrdersEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListOrdersEcommerceResponseLinksItemMethod {
