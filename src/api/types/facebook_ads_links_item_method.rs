...
pub enum FacebookAdsLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for FacebookAdsLinksItemMethod {
...
impl<'de> Deserialize<'de> for FacebookAdsLinksItemMethod {
...
impl fmt::Display for FacebookAdsLinksItemMethod {
