...
pub enum ListDefaultContentTemplatesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListDefaultContentTemplatesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListDefaultContentTemplatesResponseLinksItemMethod {
...
impl fmt::Display for ListDefaultContentTemplatesResponseLinksItemMethod {
