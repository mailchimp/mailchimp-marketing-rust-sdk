...
pub enum SubscriberListLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for SubscriberListLinksItemMethod {
...
impl<'de> Deserialize<'de> for SubscriberListLinksItemMethod {
...
impl fmt::Display for SubscriberListLinksItemMethod {
