...
pub enum CampaignsVariateSettingsWinnerCriteria {
    Opens,
    Clicks,
    Manual,
    TotalRevenue,
...
impl Serialize for CampaignsVariateSettingsWinnerCriteria {
...
impl<'de> Deserialize<'de> for CampaignsVariateSettingsWinnerCriteria {
...
impl fmt::Display for CampaignsVariateSettingsWinnerCriteria {
