...
pub enum LandingPageReportLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for LandingPageReportLinksItemMethod {
...
impl<'de> Deserialize<'de> for LandingPageReportLinksItemMethod {
...
impl fmt::Display for LandingPageReportLinksItemMethod {
