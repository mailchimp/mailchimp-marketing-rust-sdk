...
pub enum CampaignFeedbackSource {
    Api,
    Email,
    Sms,
    Web,
...
impl Serialize for CampaignFeedbackSource {
...
impl<'de> Deserialize<'de> for CampaignFeedbackSource {
...
impl fmt::Display for CampaignFeedbackSource {
