...
pub enum ListStoreCartLinesEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreCartLinesEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreCartLinesEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListStoreCartLinesEcommerceResponseLinksItemMethod {
