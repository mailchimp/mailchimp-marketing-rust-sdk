...
pub enum ListSearchMembersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSearchMembersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSearchMembersResponseLinksItemMethod {
...
impl fmt::Display for ListSearchMembersResponseLinksItemMethod {
