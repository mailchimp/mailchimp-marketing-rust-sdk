...
pub enum ListSubReportsReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSubReportsReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSubReportsReportsResponseLinksItemMethod {
...
impl fmt::Display for ListSubReportsReportsResponseLinksItemMethod {
