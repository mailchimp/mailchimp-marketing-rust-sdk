...
pub enum ListSmsCampaignsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSmsCampaignsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSmsCampaignsResponseLinksItemMethod {
...
impl fmt::Display for ListSmsCampaignsResponseLinksItemMethod {
