...
pub struct LandingPageTracking {
...
impl LandingPageTracking {
    pub fn builder() -> LandingPageTrackingBuilder {
        <LandingPageTrackingBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct LandingPageTrackingBuilder {
    enable_restricted_data_processing: Option<bool>,
    track_with_mailchimp: Option<bool>,
}

impl LandingPageTrackingBuilder {
    ...
    /// Consumes the builder and constructs a [`LandingPageTracking`].
    pub fn build(self) -> Result<LandingPageTracking, BuildError> {
        Ok(LandingPageTracking {
