...
pub enum ListMemberActivityListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberActivityListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberActivityListsResponseLinksItemMethod {
...
impl fmt::Display for ListMemberActivityListsResponseLinksItemMethod {
