...
pub struct ECommerceOrderShippingAddress {
    /// The shipping address for the order.
...
impl ECommerceOrderShippingAddress {
    pub fn builder() -> ECommerceOrderShippingAddressBuilder {
        <ECommerceOrderShippingAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ECommerceOrderShippingAddressBuilder {
...
impl ECommerceOrderShippingAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`ECommerceOrderShippingAddress`].
    pub fn build(self) -> Result<ECommerceOrderShippingAddress, BuildError> {
        Ok(ECommerceOrderShippingAddress {
