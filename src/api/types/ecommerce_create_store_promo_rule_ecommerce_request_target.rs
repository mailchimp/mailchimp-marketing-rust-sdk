...
pub enum CreateStorePromoRuleEcommerceRequestTarget {
    PerItem,
    Total,
    Shipping,
...
impl Serialize for CreateStorePromoRuleEcommerceRequestTarget {
...
impl<'de> Deserialize<'de> for CreateStorePromoRuleEcommerceRequestTarget {
...
impl fmt::Display for CreateStorePromoRuleEcommerceRequestTarget {
