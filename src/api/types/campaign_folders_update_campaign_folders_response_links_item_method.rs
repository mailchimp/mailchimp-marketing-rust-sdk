...
pub enum UpdateCampaignFoldersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for UpdateCampaignFoldersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for UpdateCampaignFoldersResponseLinksItemMethod {
...
impl fmt::Display for UpdateCampaignFoldersResponseLinksItemMethod {
