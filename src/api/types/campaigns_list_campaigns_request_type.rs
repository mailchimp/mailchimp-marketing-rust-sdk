...
pub enum ListCampaignsRequestType {
    Regular,
    Plaintext,
    Absplit,
    Rss,
...
impl Serialize for ListCampaignsRequestType {
...
impl<'de> Deserialize<'de> for ListCampaignsRequestType {
...
impl fmt::Display for ListCampaignsRequestType {
