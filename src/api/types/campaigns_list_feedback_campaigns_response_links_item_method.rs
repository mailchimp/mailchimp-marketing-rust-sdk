...
pub enum ListFeedbackCampaignsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFeedbackCampaignsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFeedbackCampaignsResponseLinksItemMethod {
...
impl fmt::Display for ListFeedbackCampaignsResponseLinksItemMethod {
