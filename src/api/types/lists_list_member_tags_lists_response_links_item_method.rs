...
pub enum ListMemberTagsListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberTagsListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberTagsListsResponseLinksItemMethod {
...
impl fmt::Display for ListMemberTagsListsResponseLinksItemMethod {
