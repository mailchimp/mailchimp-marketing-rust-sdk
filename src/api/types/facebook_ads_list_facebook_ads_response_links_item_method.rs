...
pub enum ListFacebookAdsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFacebookAdsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFacebookAdsResponseLinksItemMethod {
...
impl fmt::Display for ListFacebookAdsResponseLinksItemMethod {
