...
pub enum ListSignupFormsListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSignupFormsListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSignupFormsListsResponseLinksItemMethod {
...
impl fmt::Display for ListSignupFormsListsResponseLinksItemMethod {
