...
pub enum ListMemberNotesListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberNotesListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberNotesListsResponseLinksItemMethod {
...
impl fmt::Display for ListMemberNotesListsResponseLinksItemMethod {
