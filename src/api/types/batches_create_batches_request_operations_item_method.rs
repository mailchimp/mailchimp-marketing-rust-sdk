...
pub enum CreateBatchesRequestOperationsItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CreateBatchesRequestOperationsItemMethod {
...
impl<'de> Deserialize<'de> for CreateBatchesRequestOperationsItemMethod {
...
impl fmt::Display for CreateBatchesRequestOperationsItemMethod {
