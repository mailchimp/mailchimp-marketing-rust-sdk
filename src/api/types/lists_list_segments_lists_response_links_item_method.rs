...
pub enum ListSegmentsListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSegmentsListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSegmentsListsResponseLinksItemMethod {
...
impl fmt::Display for ListSegmentsListsResponseLinksItemMethod {
