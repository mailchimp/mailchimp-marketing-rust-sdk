...
pub enum ListMergeFieldsListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMergeFieldsListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMergeFieldsListsResponseLinksItemMethod {
...
impl fmt::Display for ListMergeFieldsListsResponseLinksItemMethod {
