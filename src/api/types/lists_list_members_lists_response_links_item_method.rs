...
pub enum ListMembersListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMembersListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMembersListsResponseLinksItemMethod {
...
impl fmt::Display for ListMembersListsResponseLinksItemMethod {
