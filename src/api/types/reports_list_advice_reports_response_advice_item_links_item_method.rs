...
pub enum ListAdviceReportsResponseAdviceItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAdviceReportsResponseAdviceItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAdviceReportsResponseAdviceItemLinksItemMethod {
...
impl fmt::Display for ListAdviceReportsResponseAdviceItemLinksItemMethod {
