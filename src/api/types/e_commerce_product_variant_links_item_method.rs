...
pub enum ECommerceProductVariantLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommerceProductVariantLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommerceProductVariantLinksItemMethod {
...
impl fmt::Display for ECommerceProductVariantLinksItemMethod {
