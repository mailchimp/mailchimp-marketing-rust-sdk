...
pub enum ListStoreCustomersEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreCustomersEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreCustomersEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListStoreCustomersEcommerceResponseLinksItemMethod {
