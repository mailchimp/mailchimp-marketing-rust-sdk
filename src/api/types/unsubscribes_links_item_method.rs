...
pub enum UnsubscribesLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for UnsubscribesLinksItemMethod {
...
impl<'de> Deserialize<'de> for UnsubscribesLinksItemMethod {
...
impl fmt::Display for UnsubscribesLinksItemMethod {
