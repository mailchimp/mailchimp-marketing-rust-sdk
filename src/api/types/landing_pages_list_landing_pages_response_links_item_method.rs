...
pub enum ListLandingPagesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListLandingPagesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListLandingPagesResponseLinksItemMethod {
...
impl fmt::Display for ListLandingPagesResponseLinksItemMethod {
