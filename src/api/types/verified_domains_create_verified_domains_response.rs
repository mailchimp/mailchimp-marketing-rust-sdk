...
pub struct CreateVerifiedDomainsResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<CreateVerifiedDomainsResponseStatus>,
...
impl CreateVerifiedDomainsResponse {
    pub fn builder() -> CreateVerifiedDomainsResponseBuilder {
        <CreateVerifiedDomainsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateVerifiedDomainsResponseBuilder {
    authenticated: Option<bool>,
    domain: Option<String>,
    is_free_email_provider: Option<bool>,
    status: Option<CreateVerifiedDomainsResponseStatus>,
    verification_email: Option<String>,
    verification_sent: Option<DateTime<FixedOffset>>,
    verified: Option<bool>,
}

impl CreateVerifiedDomainsResponseBuilder {
    ...
    pub fn status(mut self, value: CreateVerifiedDomainsResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateVerifiedDomainsResponse`].
    pub fn build(self) -> Result<CreateVerifiedDomainsResponse, BuildError> {
        Ok(CreateVerifiedDomainsResponse {
