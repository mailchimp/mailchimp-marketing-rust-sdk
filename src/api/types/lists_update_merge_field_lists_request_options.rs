...
pub struct UpdateMergeFieldListsRequestOptions {
...
impl UpdateMergeFieldListsRequestOptions {
    pub fn builder() -> UpdateMergeFieldListsRequestOptionsBuilder {
        <UpdateMergeFieldListsRequestOptionsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateMergeFieldListsRequestOptionsBuilder {
...
impl UpdateMergeFieldListsRequestOptionsBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateMergeFieldListsRequestOptions`].
    pub fn build(self) -> Result<UpdateMergeFieldListsRequestOptions, BuildError> {
        Ok(UpdateMergeFieldListsRequestOptions {
