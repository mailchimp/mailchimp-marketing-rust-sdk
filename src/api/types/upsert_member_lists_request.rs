...
pub struct UpsertMemberListsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub location: Option<UpsertMemberListsRequestLocation>,
    /// The marketing permissions for the subscriber.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub marketing_permissions: Option<Vec<UpsertMemberListsRequestMarketingPermissionsItem>>,
    /// A dictionary of merge fields where the keys are the merge tags. See the [Merge Fields documentation](https://mailchimp.com/developer/marketing/docs/merge-fields/#structure) for more about the structure.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub merge_fields: Option<HashMap<String, UpsertMemberListsRequestMergeFieldsValue>>,
    /// Subscriber's current status.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<UpsertMemberListsRequestStatus>,
    /// Subscriber's status. This value is required only if the email address is not already present on the list.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status_if_new: Option<UpsertMemberListsRequestStatusIfNew>,
    /// The tags that are associated with a member.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub timestamp_opt: Option<UpsertMemberListsRequestTimestampOpt>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub timestamp_signup: Option<UpsertMemberListsRequestTimestampSignup>,
...
impl UpsertMemberListsRequest {
    pub fn builder() -> UpsertMemberListsRequestBuilder {
        <UpsertMemberListsRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpsertMemberListsRequestBuilder {
    ...
    location: Option<UpsertMemberListsRequestLocation>,
    marketing_permissions: Option<Vec<UpsertMemberListsRequestMarketingPermissionsItem>>,
    merge_fields: Option<HashMap<String, UpsertMemberListsRequestMergeFieldsValue>>,
    status: Option<UpsertMemberListsRequestStatus>,
    status_if_new: Option<UpsertMemberListsRequestStatusIfNew>,
...
impl UpsertMemberListsRequestBuilder {
    ...
    pub fn location(mut self, value: UpsertMemberListsRequestLocation) -> Self {
    ...
    pub fn marketing_permissions(
        mut self,
        value: Vec<UpsertMemberListsRequestMarketingPermissionsItem>,
    ) -> Self {
    ...
    pub fn merge_fields(
        mut self,
        value: HashMap<String, UpsertMemberListsRequestMergeFieldsValue>,
    ) -> Self {
        self.merge_fields = Some(value);
        self
    }

    pub fn status(mut self, value: UpsertMemberListsRequestStatus) -> Self {
        self.status = Some(value);
        self
    }

    pub fn status_if_new(mut self, value: UpsertMemberListsRequestStatusIfNew) -> Self {
    ...
    pub fn timestamp_opt(mut self, value: UpsertMemberListsRequestTimestampOpt) -> Self {
        self.timestamp_opt = Some(value);
        self
    }

    pub fn timestamp_signup(mut self, value: UpsertMemberListsRequestTimestampSignup) -> Self {
    ...
    /// Consumes the builder and constructs a [`UpsertMemberListsRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`email_address`](UpsertMemberListsRequestBuilder::email_address)
    pub fn build(self) -> Result<UpsertMemberListsRequest, BuildError> {
        Ok(UpsertMemberListsRequest {
            email_address: self
                .email_address
