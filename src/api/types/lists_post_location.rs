...
impl ListsPostLocation {
    pub fn builder() -> ListsPostLocationBuilder {
        <ListsPostLocationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListsPostLocationBuilder {
...
impl ListsPostLocationBuilder {
    ...
    /// Consumes the builder and constructs a [`ListsPostLocation`].
    pub fn build(self) -> Result<ListsPostLocation, BuildError> {
        Ok(ListsPostLocation {
