...
pub struct EcommerceStoresCartsPatchAddress {
...
impl EcommerceStoresCartsPatchAddress {
    pub fn builder() -> EcommerceStoresCartsPatchAddressBuilder {
        <EcommerceStoresCartsPatchAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct EcommerceStoresCartsPatchAddressBuilder {
...
impl EcommerceStoresCartsPatchAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`EcommerceStoresCartsPatchAddress`].
    pub fn build(self) -> Result<EcommerceStoresCartsPatchAddress, BuildError> {
        Ok(EcommerceStoresCartsPatchAddress {
