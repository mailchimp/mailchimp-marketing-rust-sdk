...
pub enum CampaignFoldersFoldersItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CampaignFoldersFoldersItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for CampaignFoldersFoldersItemLinksItemMethod {
...
impl fmt::Display for CampaignFoldersFoldersItemLinksItemMethod {
