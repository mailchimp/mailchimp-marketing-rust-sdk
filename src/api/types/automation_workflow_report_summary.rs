...
pub struct AutomationWorkflowReportSummary {
...
impl AutomationWorkflowReportSummary {
    pub fn builder() -> AutomationWorkflowReportSummaryBuilder {
        <AutomationWorkflowReportSummaryBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AutomationWorkflowReportSummaryBuilder {
...
impl AutomationWorkflowReportSummaryBuilder {
    ...
    /// Consumes the builder and constructs a [`AutomationWorkflowReportSummary`].
    pub fn build(self) -> Result<AutomationWorkflowReportSummary, BuildError> {
        Ok(AutomationWorkflowReportSummary {
