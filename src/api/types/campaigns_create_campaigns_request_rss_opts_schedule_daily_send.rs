...
pub struct CreateCampaignsRequestRssOptsScheduleDailySend {
...
impl CreateCampaignsRequestRssOptsScheduleDailySend {
    pub fn builder() -> CreateCampaignsRequestRssOptsScheduleDailySendBuilder {
        <CreateCampaignsRequestRssOptsScheduleDailySendBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateCampaignsRequestRssOptsScheduleDailySendBuilder {
    friday: Option<bool>,
    monday: Option<bool>,
...
impl CreateCampaignsRequestRssOptsScheduleDailySendBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateCampaignsRequestRssOptsScheduleDailySend`].
    pub fn build(self) -> Result<CreateCampaignsRequestRssOptsScheduleDailySend, BuildError> {
        Ok(CreateCampaignsRequestRssOptsScheduleDailySend {
            friday: self.friday,
            monday: self.monday,
