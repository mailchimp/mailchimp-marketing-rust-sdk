...
pub enum LandingPageLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for LandingPageLinksItemMethod {
...
impl<'de> Deserialize<'de> for LandingPageLinksItemMethod {
...
impl fmt::Display for LandingPageLinksItemMethod {
