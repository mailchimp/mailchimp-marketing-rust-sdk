...
pub enum InterestLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for InterestLinksItemMethod {
...
impl<'de> Deserialize<'de> for InterestLinksItemMethod {
...
impl fmt::Display for InterestLinksItemMethod {
