...
pub enum ListsSegmentsMembersStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for ListsSegmentsMembersStatus {
...
impl<'de> Deserialize<'de> for ListsSegmentsMembersStatus {
...
impl fmt::Display for ListsSegmentsMembersStatus {
