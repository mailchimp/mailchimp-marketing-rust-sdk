...
pub enum SmsCampaignLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for SmsCampaignLinksItemMethod {
...
impl<'de> Deserialize<'de> for SmsCampaignLinksItemMethod {
...
impl fmt::Display for SmsCampaignLinksItemMethod {
