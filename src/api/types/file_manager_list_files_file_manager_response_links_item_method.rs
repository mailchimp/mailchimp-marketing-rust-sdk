...
pub enum ListFilesFileManagerResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFilesFileManagerResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFilesFileManagerResponseLinksItemMethod {
...
impl fmt::Display for ListFilesFileManagerResponseLinksItemMethod {
