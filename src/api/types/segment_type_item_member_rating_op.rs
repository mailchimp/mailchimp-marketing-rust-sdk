...
pub enum SegmentTypeItemMemberRatingOp {
    Is,
    Not,
    Greater,
    Less,
...
impl Serialize for SegmentTypeItemMemberRatingOp {
...
impl<'de> Deserialize<'de> for SegmentTypeItemMemberRatingOp {
...
impl fmt::Display for SegmentTypeItemMemberRatingOp {
