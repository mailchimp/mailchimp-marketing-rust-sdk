...
pub enum AudiencesContactSmsChannelMarketingConsentStatus {
    Consented,
    Confirmed,
    Denied,
    Unknown,
...
impl Serialize for AudiencesContactSmsChannelMarketingConsentStatus {
...
impl<'de> Deserialize<'de> for AudiencesContactSmsChannelMarketingConsentStatus {
...
impl fmt::Display for AudiencesContactSmsChannelMarketingConsentStatus {
