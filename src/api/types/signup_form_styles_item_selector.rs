...
pub enum SignupFormStylesItemSelector {
    PageBackground,
    PageHeader,
    PageOuterWrapper,
    BodyBackground,
...
impl Serialize for SignupFormStylesItemSelector {
...
impl<'de> Deserialize<'de> for SignupFormStylesItemSelector {
...
impl fmt::Display for SignupFormStylesItemSelector {
