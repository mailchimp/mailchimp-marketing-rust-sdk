...
pub enum ListMemberEventsListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberEventsListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberEventsListsResponseLinksItemMethod {
...
impl fmt::Display for ListMemberEventsListsResponseLinksItemMethod {
