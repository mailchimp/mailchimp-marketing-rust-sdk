...
pub enum AutomationWorkflowEmailLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for AutomationWorkflowEmailLinksItemMethod {
...
impl<'de> Deserialize<'de> for AutomationWorkflowEmailLinksItemMethod {
...
impl fmt::Display for AutomationWorkflowEmailLinksItemMethod {
