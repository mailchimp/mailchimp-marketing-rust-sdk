...
pub enum ECommerceProductImagesItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommerceProductImagesItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommerceProductImagesItemLinksItemMethod {
...
impl fmt::Display for ECommerceProductImagesItemLinksItemMethod {
