...
pub enum MemberNotesLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for MemberNotesLinksItemMethod {
...
impl<'de> Deserialize<'de> for MemberNotesLinksItemMethod {
...
impl fmt::Display for MemberNotesLinksItemMethod {
