...
pub enum ListConversationsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListConversationsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListConversationsResponseLinksItemMethod {
...
impl fmt::Display for ListConversationsResponseLinksItemMethod {
