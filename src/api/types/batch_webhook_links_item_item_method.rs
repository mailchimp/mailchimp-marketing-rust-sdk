...
pub enum BatchWebhookLinksItemItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for BatchWebhookLinksItemItemMethod {
...
impl<'de> Deserialize<'de> for BatchWebhookLinksItemItemMethod {
...
impl fmt::Display for BatchWebhookLinksItemItemMethod {
