...
pub enum ListClickDetailsReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListClickDetailsReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListClickDetailsReportsResponseLinksItemMethod {
...
impl fmt::Display for ListClickDetailsReportsResponseLinksItemMethod {
