...
pub struct ListsSegmentsMembers {
    /// A list of link types and descriptions for the API schema documents.
    #[serde(rename = "_links")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub links: Option<Vec<ListsSegmentsMembersLinksItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub last_note: Option<ListsSegmentsMembersLastNote>,
    /// The list id.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub list_id: Option<String>,
    /// Subscriber location information.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub location: Option<ListsSegmentsMembersLocation>,
    /// Star rating for this member, between 1 and 5.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub member_rating: Option<i64>,
    /// A dictionary of merge fields where the keys are the merge tags. See the [Merge Fields documentation](https://mailchimp.com/developer/marketing/docs/merge-fields/#structure) for more about the structure.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub merge_fields: Option<HashMap<String, ListsSegmentsMembersMergeFieldsValue>>,
    /// Open and click rates for this subscriber.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stats: Option<ListsSegmentsMembersStats>,
    /// Subscriber's current status.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListsSegmentsMembersStatus>,
...
impl ListsSegmentsMembers {
    pub fn builder() -> ListsSegmentsMembersBuilder {
        <ListsSegmentsMembersBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListsSegmentsMembersBuilder {
    links: Option<Vec<ListsSegmentsMembersLinksItem>>,
    ...
    last_note: Option<ListsSegmentsMembersLastNote>,
    list_id: Option<String>,
    location: Option<ListsSegmentsMembersLocation>,
    member_rating: Option<i64>,
    merge_fields: Option<HashMap<String, ListsSegmentsMembersMergeFieldsValue>>,
    stats: Option<ListsSegmentsMembersStats>,
    status: Option<ListsSegmentsMembersStatus>,
...
impl ListsSegmentsMembersBuilder {
    pub fn links(mut self, value: Vec<ListsSegmentsMembersLinksItem>) -> Self {
    ...
    pub fn last_note(mut self, value: ListsSegmentsMembersLastNote) -> Self {
    ...
    pub fn location(mut self, value: ListsSegmentsMembersLocation) -> Self {
    ...
    pub fn merge_fields(
        mut self,
        value: HashMap<String, ListsSegmentsMembersMergeFieldsValue>,
    ) -> Self {
        self.merge_fields = Some(value);
        self
    }

    pub fn stats(mut self, value: ListsSegmentsMembersStats) -> Self {
        self.stats = Some(value);
        self
    }

    pub fn status(mut self, value: ListsSegmentsMembersStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListsSegmentsMembers`].
    pub fn build(self) -> Result<ListsSegmentsMembers, BuildError> {
        Ok(ListsSegmentsMembers {
            links: self.links,
