...
pub enum ListFacebookAdsReportingResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFacebookAdsReportingResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFacebookAdsReportingResponseLinksItemMethod {
...
impl fmt::Display for ListFacebookAdsReportingResponseLinksItemMethod {
