...
pub enum ListMessagesConversationsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMessagesConversationsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMessagesConversationsResponseLinksItemMethod {
...
impl fmt::Display for ListMessagesConversationsResponseLinksItemMethod {
