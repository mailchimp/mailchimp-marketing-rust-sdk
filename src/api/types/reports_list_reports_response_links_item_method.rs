...
pub enum ListReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListReportsResponseLinksItemMethod {
...
impl fmt::Display for ListReportsResponseLinksItemMethod {
