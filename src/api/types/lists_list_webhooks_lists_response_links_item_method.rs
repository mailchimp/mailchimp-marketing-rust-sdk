...
pub enum ListWebhooksListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListWebhooksListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListWebhooksListsResponseLinksItemMethod {
...
impl fmt::Display for ListWebhooksListsResponseLinksItemMethod {
