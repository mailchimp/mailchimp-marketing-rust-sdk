...
pub enum InterestCategoryLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for InterestCategoryLinksItemMethod {
...
impl<'de> Deserialize<'de> for InterestCategoryLinksItemMethod {
...
impl fmt::Display for InterestCategoryLinksItemMethod {
