...
pub enum ConversationLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ConversationLinksItemMethod {
...
impl<'de> Deserialize<'de> for ConversationLinksItemMethod {
...
impl fmt::Display for ConversationLinksItemMethod {
