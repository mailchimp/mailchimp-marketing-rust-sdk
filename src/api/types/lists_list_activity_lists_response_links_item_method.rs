...
pub enum ListActivityListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListActivityListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListActivityListsResponseLinksItemMethod {
...
impl fmt::Display for ListActivityListsResponseLinksItemMethod {
