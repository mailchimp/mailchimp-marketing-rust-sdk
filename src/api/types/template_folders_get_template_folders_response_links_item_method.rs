...
pub enum GetTemplateFoldersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GetTemplateFoldersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for GetTemplateFoldersResponseLinksItemMethod {
...
impl fmt::Display for GetTemplateFoldersResponseLinksItemMethod {
