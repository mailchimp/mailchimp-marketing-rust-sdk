...
pub enum ListMembersListsRequestStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for ListMembersListsRequestStatus {
...
impl<'de> Deserialize<'de> for ListMembersListsRequestStatus {
...
impl fmt::Display for ListMembersListsRequestStatus {
