...
pub enum ListDomainPerformanceReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListDomainPerformanceReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListDomainPerformanceReportsResponseLinksItemMethod {
...
impl fmt::Display for ListDomainPerformanceReportsResponseLinksItemMethod {
