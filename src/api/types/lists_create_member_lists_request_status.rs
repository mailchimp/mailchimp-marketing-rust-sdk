...
pub enum CreateMemberListsRequestStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for CreateMemberListsRequestStatus {
...
impl<'de> Deserialize<'de> for CreateMemberListsRequestStatus {
...
impl fmt::Display for CreateMemberListsRequestStatus {
