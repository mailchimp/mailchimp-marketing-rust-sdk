...
pub enum ListStoreOrderLinesEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreOrderLinesEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreOrderLinesEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListStoreOrderLinesEcommerceResponseLinksItemMethod {
