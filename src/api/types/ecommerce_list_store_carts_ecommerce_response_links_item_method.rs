...
pub enum ListStoreCartsEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreCartsEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreCartsEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListStoreCartsEcommerceResponseLinksItemMethod {
