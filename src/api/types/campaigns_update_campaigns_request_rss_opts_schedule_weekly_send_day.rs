...
pub enum UpdateCampaignsRequestRssOptsScheduleWeeklySendDay {
    Sunday,
    Monday,
    Tuesday,
    Wednesday,
...
impl Serialize for UpdateCampaignsRequestRssOptsScheduleWeeklySendDay {
...
impl<'de> Deserialize<'de> for UpdateCampaignsRequestRssOptsScheduleWeeklySendDay {
...
impl fmt::Display for UpdateCampaignsRequestRssOptsScheduleWeeklySendDay {
