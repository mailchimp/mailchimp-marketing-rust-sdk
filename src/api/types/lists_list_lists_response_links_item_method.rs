...
pub enum ListListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListListsResponseLinksItemMethod {
...
impl fmt::Display for ListListsResponseLinksItemMethod {
