...
pub enum CreateTemplateFoldersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CreateTemplateFoldersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for CreateTemplateFoldersResponseLinksItemMethod {
...
impl fmt::Display for CreateTemplateFoldersResponseLinksItemMethod {
