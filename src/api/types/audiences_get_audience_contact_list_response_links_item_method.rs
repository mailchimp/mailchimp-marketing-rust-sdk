...
pub enum GetAudienceContactListResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GetAudienceContactListResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for GetAudienceContactListResponseLinksItemMethod {
...
impl fmt::Display for GetAudienceContactListResponseLinksItemMethod {
