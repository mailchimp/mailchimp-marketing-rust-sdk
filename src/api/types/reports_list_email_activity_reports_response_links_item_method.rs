...
pub enum ListEmailActivityReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEmailActivityReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListEmailActivityReportsResponseLinksItemMethod {
...
impl fmt::Display for ListEmailActivityReportsResponseLinksItemMethod {
