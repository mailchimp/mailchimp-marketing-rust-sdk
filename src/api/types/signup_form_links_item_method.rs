...
pub enum SignupFormLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for SignupFormLinksItemMethod {
...
impl<'de> Deserialize<'de> for SignupFormLinksItemMethod {
...
impl fmt::Display for SignupFormLinksItemMethod {
