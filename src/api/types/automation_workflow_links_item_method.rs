...
pub enum AutomationWorkflowLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for AutomationWorkflowLinksItemMethod {
...
impl<'de> Deserialize<'de> for AutomationWorkflowLinksItemMethod {
...
impl fmt::Display for AutomationWorkflowLinksItemMethod {
