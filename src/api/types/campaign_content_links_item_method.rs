...
pub enum CampaignContentLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CampaignContentLinksItemMethod {
...
impl<'de> Deserialize<'de> for CampaignContentLinksItemMethod {
...
impl fmt::Display for CampaignContentLinksItemMethod {
