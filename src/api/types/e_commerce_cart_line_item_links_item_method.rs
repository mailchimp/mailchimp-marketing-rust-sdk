...
pub enum ECommerceCartLineItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommerceCartLineItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommerceCartLineItemLinksItemMethod {
...
impl fmt::Display for ECommerceCartLineItemLinksItemMethod {
