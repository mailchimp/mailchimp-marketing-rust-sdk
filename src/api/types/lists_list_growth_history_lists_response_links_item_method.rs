...
pub enum ListGrowthHistoryListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListGrowthHistoryListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListGrowthHistoryListsResponseLinksItemMethod {
...
impl fmt::Display for ListGrowthHistoryListsResponseLinksItemMethod {
