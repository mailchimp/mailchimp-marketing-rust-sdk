...
pub struct UpdateStoreOrderEcommerceRequestBillingAddress {
    /// The billing address for the order.
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub latitude: Option<UpdateStoreOrderEcommerceRequestBillingAddressLatitude>,
    /// The longitude for the billing address location.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub longitude: Option<UpdateStoreOrderEcommerceRequestBillingAddressLongitude>,
...
impl UpdateStoreOrderEcommerceRequestBillingAddress {
    pub fn builder() -> UpdateStoreOrderEcommerceRequestBillingAddressBuilder {
        <UpdateStoreOrderEcommerceRequestBillingAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateStoreOrderEcommerceRequestBillingAddressBuilder {
    ...
    latitude: Option<UpdateStoreOrderEcommerceRequestBillingAddressLatitude>,
    longitude: Option<UpdateStoreOrderEcommerceRequestBillingAddressLongitude>,
    name: Option<String>,
    phone: Option<String>,
...
impl UpdateStoreOrderEcommerceRequestBillingAddressBuilder {
    ...
    pub fn latitude(
        mut self,
        value: UpdateStoreOrderEcommerceRequestBillingAddressLatitude,
    ) -> Self {
    ...
    pub fn longitude(
        mut self,
        value: UpdateStoreOrderEcommerceRequestBillingAddressLongitude,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`UpdateStoreOrderEcommerceRequestBillingAddress`].
    pub fn build(self) -> Result<UpdateStoreOrderEcommerceRequestBillingAddress, BuildError> {
        Ok(UpdateStoreOrderEcommerceRequestBillingAddress {
