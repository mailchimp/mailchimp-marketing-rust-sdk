...
pub enum CampaignsResendShortcutUsageShortcutCampaignsItemShortcutType {
    NonOpeners,
    NewSubscribers,
    NonClickers,
    NonPurchasers,
...
impl Serialize for CampaignsResendShortcutUsageShortcutCampaignsItemShortcutType {
...
impl<'de> Deserialize<'de> for CampaignsResendShortcutUsageShortcutCampaignsItemShortcutType {
...
impl fmt::Display for CampaignsResendShortcutUsageShortcutCampaignsItemShortcutType {
