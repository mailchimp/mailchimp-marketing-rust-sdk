...
pub enum ListFileManagerResponseItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFileManagerResponseItemMethod {
...
impl<'de> Deserialize<'de> for ListFileManagerResponseItemMethod {
...
impl fmt::Display for ListFileManagerResponseItemMethod {
