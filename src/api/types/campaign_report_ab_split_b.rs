...
pub struct CampaignReportAbSplitB {
...
impl CampaignReportAbSplitB {
    pub fn builder() -> CampaignReportAbSplitBBuilder {
        <CampaignReportAbSplitBBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CampaignReportAbSplitBBuilder {
...
impl CampaignReportAbSplitBBuilder {
    ...
    /// Consumes the builder and constructs a [`CampaignReportAbSplitB`].
    pub fn build(self) -> Result<CampaignReportAbSplitB, BuildError> {
        Ok(CampaignReportAbSplitB {
