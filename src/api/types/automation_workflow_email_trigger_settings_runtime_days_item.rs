...
pub enum AutomationWorkflowEmailTriggerSettingsRuntimeDaysItem {
    Sunday,
    Monday,
    Tuesday,
    Wednesday,
...
impl Serialize for AutomationWorkflowEmailTriggerSettingsRuntimeDaysItem {
...
impl<'de> Deserialize<'de> for AutomationWorkflowEmailTriggerSettingsRuntimeDaysItem {
...
impl fmt::Display for AutomationWorkflowEmailTriggerSettingsRuntimeDaysItem {
