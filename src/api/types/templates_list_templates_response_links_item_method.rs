...
pub enum ListTemplatesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListTemplatesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListTemplatesResponseLinksItemMethod {
...
impl fmt::Display for ListTemplatesResponseLinksItemMethod {
