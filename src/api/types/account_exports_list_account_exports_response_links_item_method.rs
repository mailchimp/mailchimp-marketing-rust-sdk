...
pub enum ListAccountExportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAccountExportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAccountExportsResponseLinksItemMethod {
...
impl fmt::Display for ListAccountExportsResponseLinksItemMethod {
