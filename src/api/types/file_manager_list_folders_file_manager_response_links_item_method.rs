...
pub enum ListFoldersFileManagerResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFoldersFileManagerResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFoldersFileManagerResponseLinksItemMethod {
...
impl fmt::Display for ListFoldersFileManagerResponseLinksItemMethod {
