...
pub enum GetAccountExportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GetAccountExportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for GetAccountExportsResponseLinksItemMethod {
...
impl fmt::Display for GetAccountExportsResponseLinksItemMethod {
