...
pub enum TemplateInstanceLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for TemplateInstanceLinksItemMethod {
...
impl<'de> Deserialize<'de> for TemplateInstanceLinksItemMethod {
...
impl fmt::Display for TemplateInstanceLinksItemMethod {
