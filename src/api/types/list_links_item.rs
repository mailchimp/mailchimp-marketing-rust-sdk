...
pub struct ListLinksItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub method: Option<ListLinksItemMethod>,
...
impl ListLinksItem {
    pub fn builder() -> ListLinksItemBuilder {
        <ListLinksItemBuilder as Default>::default()
    }
}
...
pub struct ListLinksItemBuilder {
    href: Option<String>,
    method: Option<ListLinksItemMethod>,
    rel: Option<String>,
...
impl ListLinksItemBuilder {
    ...
    pub fn method(mut self, value: ListLinksItemMethod) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListLinksItem`].
    pub fn build(self) -> Result<ListLinksItem, BuildError> {
        Ok(ListLinksItem {
            href: self.href,
            method: self.method,
            rel: self.rel,
