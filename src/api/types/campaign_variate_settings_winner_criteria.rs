...
pub enum CampaignVariateSettingsWinnerCriteria {
    Opens,
    Clicks,
    Manual,
    TotalRevenue,
...
impl Serialize for CampaignVariateSettingsWinnerCriteria {
...
impl<'de> Deserialize<'de> for CampaignVariateSettingsWinnerCriteria {
...
impl fmt::Display for CampaignVariateSettingsWinnerCriteria {
