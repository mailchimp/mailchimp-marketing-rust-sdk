...
#[serde(untagged)]
pub enum CreateCampaignsRequestVariateSettingsSendTimesItem {
    DateTime(#[serde(with = "crate::core::flexible_datetime::offset")] DateTime<FixedOffset>),

    String(String),
}

impl CreateCampaignsRequestVariateSettingsSendTimesItem {
...
impl fmt::Display for CreateCampaignsRequestVariateSettingsSendTimesItem {
