...
pub enum ReportingFacebookAdLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ReportingFacebookAdLinksItemMethod {
...
impl<'de> Deserialize<'de> for ReportingFacebookAdLinksItemMethod {
...
impl fmt::Display for ReportingFacebookAdLinksItemMethod {
