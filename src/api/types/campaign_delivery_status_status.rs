...
pub enum CampaignDeliveryStatusStatus {
    Delivering,
    Delivered,
    Canceling,
    Canceled,
...
impl Serialize for CampaignDeliveryStatusStatus {
...
impl<'de> Deserialize<'de> for CampaignDeliveryStatusStatus {
...
impl fmt::Display for CampaignDeliveryStatusStatus {
