...
pub enum ListMembersLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMembersLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMembersLinksItemMethod {
...
impl fmt::Display for ListMembersLinksItemMethod {
