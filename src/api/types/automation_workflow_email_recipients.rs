...
pub struct AutomationWorkflowEmailRecipients {
    /// The unique list id.
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub segment_opts: Option<AutomationWorkflowEmailRecipientsSegmentOpts>,
...
impl AutomationWorkflowEmailRecipients {
    pub fn builder() -> AutomationWorkflowEmailRecipientsBuilder {
        <AutomationWorkflowEmailRecipientsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AutomationWorkflowEmailRecipientsBuilder {
    list_id: Option<String>,
    list_is_active: Option<bool>,
    list_name: Option<String>,
    recipient_count: Option<i64>,
    segment_opts: Option<AutomationWorkflowEmailRecipientsSegmentOpts>,
    segment_text: Option<String>,
}

impl AutomationWorkflowEmailRecipientsBuilder {
    ...
    pub fn segment_opts(mut self, value: AutomationWorkflowEmailRecipientsSegmentOpts) -> Self {
    ...
    /// Consumes the builder and constructs a [`AutomationWorkflowEmailRecipients`].
    pub fn build(self) -> Result<AutomationWorkflowEmailRecipients, BuildError> {
        Ok(AutomationWorkflowEmailRecipients {
