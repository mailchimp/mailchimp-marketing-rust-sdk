...
pub enum ListAbuseReportsReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAbuseReportsReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAbuseReportsReportsResponseLinksItemMethod {
...
impl fmt::Display for ListAbuseReportsReportsResponseLinksItemMethod {
