...
pub enum ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus {
    Subscribed,
    Unsubscribed,
    NonSubscribed,
    Cleaned,
...
impl Serialize for ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus {
...
impl<'de> Deserialize<'de> for ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus {
...
impl fmt::Display for ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus {
