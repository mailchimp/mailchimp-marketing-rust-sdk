...
pub enum GetVerifiedDomainsResponseStatus {
...
impl Serialize for GetVerifiedDomainsResponseStatus {
...
impl<'de> Deserialize<'de> for GetVerifiedDomainsResponseStatus {
...
impl fmt::Display for GetVerifiedDomainsResponseStatus {
