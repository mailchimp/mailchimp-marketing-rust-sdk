...
pub struct CreateMemberListsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub location: Option<CreateMemberListsRequestLocation>,
    /// The marketing permissions for the subscriber.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub marketing_permissions: Option<Vec<CreateMemberListsRequestMarketingPermissionsItem>>,
    /// A dictionary of merge fields where the keys are the merge tags. See the [Merge Fields documentation](https://mailchimp.com/developer/marketing/docs/merge-fields/#structure) for more about the structure.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub merge_fields: Option<HashMap<String, CreateMemberListsRequestMergeFieldsValue>>,
    /// Subscriber's current status.
    pub status: CreateMemberListsRequestStatus,
    /// The tags that are associated with a member.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<String>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub timestamp_opt: Option<CreateMemberListsRequestTimestampOpt>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub timestamp_signup: Option<CreateMemberListsRequestTimestampSignup>,
...
impl CreateMemberListsRequest {
    pub fn builder() -> CreateMemberListsRequestBuilder {
        <CreateMemberListsRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateMemberListsRequestBuilder {
    ...
    location: Option<CreateMemberListsRequestLocation>,
    marketing_permissions: Option<Vec<CreateMemberListsRequestMarketingPermissionsItem>>,
    merge_fields: Option<HashMap<String, CreateMemberListsRequestMergeFieldsValue>>,
    status: Option<CreateMemberListsRequestStatus>,
...
impl CreateMemberListsRequestBuilder {
    ...
    pub fn location(mut self, value: CreateMemberListsRequestLocation) -> Self {
    ...
    pub fn marketing_permissions(
        mut self,
        value: Vec<CreateMemberListsRequestMarketingPermissionsItem>,
    ) -> Self {
    ...
    pub fn merge_fields(
        mut self,
        value: HashMap<String, CreateMemberListsRequestMergeFieldsValue>,
    ) -> Self {
        self.merge_fields = Some(value);
        self
    }

    pub fn status(mut self, value: CreateMemberListsRequestStatus) -> Self {
    ...
    pub fn timestamp_opt(mut self, value: CreateMemberListsRequestTimestampOpt) -> Self {
        self.timestamp_opt = Some(value);
        self
    }

    pub fn timestamp_signup(mut self, value: CreateMemberListsRequestTimestampSignup) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateMemberListsRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`email_address`](CreateMemberListsRequestBuilder::email_address)
    /// - [`status`](CreateMemberListsRequestBuilder::status)
    pub fn build(self) -> Result<CreateMemberListsRequest, BuildError> {
        Ok(CreateMemberListsRequest {
            email_address: self
                .email_address
