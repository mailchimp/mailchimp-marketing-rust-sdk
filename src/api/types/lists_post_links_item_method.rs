...
pub enum ListsPostLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListsPostLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListsPostLinksItemMethod {
...
impl fmt::Display for ListsPostLinksItemMethod {
