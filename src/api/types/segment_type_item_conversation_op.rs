...
pub enum SegmentTypeItemConversationOp {
    Member,
    Notmember,
...
impl Serialize for SegmentTypeItemConversationOp {
...
impl<'de> Deserialize<'de> for SegmentTypeItemConversationOp {
...
impl fmt::Display for SegmentTypeItemConversationOp {
