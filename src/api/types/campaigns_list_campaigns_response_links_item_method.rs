...
pub enum ListCampaignsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListCampaignsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListCampaignsResponseLinksItemMethod {
...
impl fmt::Display for ListCampaignsResponseLinksItemMethod {
