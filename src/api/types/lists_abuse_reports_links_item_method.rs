...
pub enum ListsAbuseReportsLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListsAbuseReportsLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListsAbuseReportsLinksItemMethod {
...
impl fmt::Display for ListsAbuseReportsLinksItemMethod {
