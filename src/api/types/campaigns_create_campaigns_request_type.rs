...
pub enum CreateCampaignsRequestType {
    Regular,
    Plaintext,
    Absplit,
    Rss,
...
impl Serialize for CreateCampaignsRequestType {
...
impl<'de> Deserialize<'de> for CreateCampaignsRequestType {
...
impl fmt::Display for CreateCampaignsRequestType {
