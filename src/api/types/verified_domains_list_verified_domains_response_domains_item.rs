...
pub struct ListVerifiedDomainsResponseDomainsItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListVerifiedDomainsResponseDomainsItemStatus>,
...
impl ListVerifiedDomainsResponseDomainsItem {
    pub fn builder() -> ListVerifiedDomainsResponseDomainsItemBuilder {
        <ListVerifiedDomainsResponseDomainsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListVerifiedDomainsResponseDomainsItemBuilder {
    authenticated: Option<bool>,
    domain: Option<String>,
    is_free_email_provider: Option<bool>,
    status: Option<ListVerifiedDomainsResponseDomainsItemStatus>,
    verification_email: Option<String>,
    verification_sent: Option<DateTime<FixedOffset>>,
    verified: Option<bool>,
}

impl ListVerifiedDomainsResponseDomainsItemBuilder {
    ...
    pub fn status(mut self, value: ListVerifiedDomainsResponseDomainsItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListVerifiedDomainsResponseDomainsItem`].
    pub fn build(self) -> Result<ListVerifiedDomainsResponseDomainsItem, BuildError> {
        Ok(ListVerifiedDomainsResponseDomainsItem {
