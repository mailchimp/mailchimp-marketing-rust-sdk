...
pub enum CampaignLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CampaignLinksItemMethod {
...
impl<'de> Deserialize<'de> for CampaignLinksItemMethod {
...
impl fmt::Display for CampaignLinksItemMethod {
