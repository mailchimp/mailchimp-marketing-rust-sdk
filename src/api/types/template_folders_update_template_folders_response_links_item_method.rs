...
pub enum UpdateTemplateFoldersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for UpdateTemplateFoldersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for UpdateTemplateFoldersResponseLinksItemMethod {
...
impl fmt::Display for UpdateTemplateFoldersResponseLinksItemMethod {
