...
pub enum CreateAccountExportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CreateAccountExportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for CreateAccountExportsResponseLinksItemMethod {
...
impl fmt::Display for CreateAccountExportsResponseLinksItemMethod {
