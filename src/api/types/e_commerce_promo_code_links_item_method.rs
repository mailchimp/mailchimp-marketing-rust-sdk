...
pub enum ECommercePromoCodeLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommercePromoCodeLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommercePromoCodeLinksItemMethod {
...
impl fmt::Display for ECommercePromoCodeLinksItemMethod {
