...
pub enum ListReportsRequestType {
    Regular,
    Plaintext,
    Absplit,
    Rss,
...
impl Serialize for ListReportsRequestType {
...
impl<'de> Deserialize<'de> for ListReportsRequestType {
...
impl fmt::Display for ListReportsRequestType {
