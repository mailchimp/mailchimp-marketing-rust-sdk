...
pub enum AutomationWorkflowTriggerSettingsRuntimeDaysItem {
    Sunday,
    Monday,
    Tuesday,
    Wednesday,
...
impl Serialize for AutomationWorkflowTriggerSettingsRuntimeDaysItem {
...
impl<'de> Deserialize<'de> for AutomationWorkflowTriggerSettingsRuntimeDaysItem {
...
impl fmt::Display for AutomationWorkflowTriggerSettingsRuntimeDaysItem {
