...
pub enum SegmentTypeItemCampaignPollOp {
    Member,
    Notmember,
...
impl Serialize for SegmentTypeItemCampaignPollOp {
...
impl<'de> Deserialize<'de> for SegmentTypeItemCampaignPollOp {
...
impl fmt::Display for SegmentTypeItemCampaignPollOp {
