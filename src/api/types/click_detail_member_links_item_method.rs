...
pub enum ClickDetailMemberLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ClickDetailMemberLinksItemMethod {
...
impl<'de> Deserialize<'de> for ClickDetailMemberLinksItemMethod {
...
impl fmt::Display for ClickDetailMemberLinksItemMethod {
