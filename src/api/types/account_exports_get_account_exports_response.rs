...
pub struct GetAccountExportsResponse {
    /// A list of link types and descriptions for the API schema documents.
    #[serde(rename = "_links")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub links: Option<Vec<GetAccountExportsResponseLinksItem>>,
...
impl GetAccountExportsResponse {
    pub fn builder() -> GetAccountExportsResponseBuilder {
        <GetAccountExportsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetAccountExportsResponseBuilder {
    links: Option<Vec<GetAccountExportsResponseLinksItem>>,
...
impl GetAccountExportsResponseBuilder {
    pub fn links(mut self, value: Vec<GetAccountExportsResponseLinksItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`GetAccountExportsResponse`].
    pub fn build(self) -> Result<GetAccountExportsResponse, BuildError> {
        Ok(GetAccountExportsResponse {
            links: self.links,
