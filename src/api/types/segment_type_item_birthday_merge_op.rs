...
pub enum SegmentTypeItemBirthdayMergeOp {
    Is,
    Not,
    Blank,
    BlankNot,
...
impl Serialize for SegmentTypeItemBirthdayMergeOp {
...
impl<'de> Deserialize<'de> for SegmentTypeItemBirthdayMergeOp {
...
impl fmt::Display for SegmentTypeItemBirthdayMergeOp {
