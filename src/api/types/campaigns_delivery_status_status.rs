...
pub enum CampaignsDeliveryStatusStatus {
    Delivering,
    Delivered,
    Canceling,
    Canceled,
...
impl Serialize for CampaignsDeliveryStatusStatus {
...
impl<'de> Deserialize<'de> for CampaignsDeliveryStatusStatus {
...
impl fmt::Display for CampaignsDeliveryStatusStatus {
