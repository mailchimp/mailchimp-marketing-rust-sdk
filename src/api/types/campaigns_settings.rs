...
impl CampaignsSettings {
    pub fn builder() -> CampaignsSettingsBuilder {
        <CampaignsSettingsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CampaignsSettingsBuilder {
...
impl CampaignsSettingsBuilder {
    ...
    /// Consumes the builder and constructs a [`CampaignsSettings`].
    pub fn build(self) -> Result<CampaignsSettings, BuildError> {
        Ok(CampaignsSettings {
