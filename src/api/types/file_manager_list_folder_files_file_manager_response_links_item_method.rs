...
pub enum ListFolderFilesFileManagerResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListFolderFilesFileManagerResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListFolderFilesFileManagerResponseLinksItemMethod {
...
impl fmt::Display for ListFolderFilesFileManagerResponseLinksItemMethod {
