...
pub enum ListMemberActivityFeedListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListMemberActivityFeedListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListMemberActivityFeedListsResponseLinksItemMethod {
...
impl fmt::Display for ListMemberActivityFeedListsResponseLinksItemMethod {
