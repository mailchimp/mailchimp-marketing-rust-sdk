...
pub enum ListConnectedSitesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListConnectedSitesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListConnectedSitesResponseLinksItemMethod {
...
impl fmt::Display for ListConnectedSitesResponseLinksItemMethod {
