...
pub enum CampaignFeedbackLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CampaignFeedbackLinksItemMethod {
...
impl<'de> Deserialize<'de> for CampaignFeedbackLinksItemMethod {
...
impl fmt::Display for CampaignFeedbackLinksItemMethod {
