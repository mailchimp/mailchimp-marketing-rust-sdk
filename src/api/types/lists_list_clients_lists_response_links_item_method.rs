...
pub enum ListClientsListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListClientsListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListClientsListsResponseLinksItemMethod {
...
impl fmt::Display for ListClientsListsResponseLinksItemMethod {
