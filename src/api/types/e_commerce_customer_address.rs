...
pub struct ECommerceCustomerAddress {
...
impl ECommerceCustomerAddress {
    pub fn builder() -> ECommerceCustomerAddressBuilder {
        <ECommerceCustomerAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ECommerceCustomerAddressBuilder {
...
impl ECommerceCustomerAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`ECommerceCustomerAddress`].
    pub fn build(self) -> Result<ECommerceCustomerAddress, BuildError> {
        Ok(ECommerceCustomerAddress {
