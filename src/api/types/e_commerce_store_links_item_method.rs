...
pub enum ECommerceStoreLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommerceStoreLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommerceStoreLinksItemMethod {
...
impl fmt::Display for ECommerceStoreLinksItemMethod {
