...
pub enum ListContentLandingPagesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListContentLandingPagesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListContentLandingPagesResponseLinksItemMethod {
...
impl fmt::Display for ListContentLandingPagesResponseLinksItemMethod {
