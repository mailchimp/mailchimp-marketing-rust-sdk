...
pub enum CreateFolderFileManagerResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CreateFolderFileManagerResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for CreateFolderFileManagerResponseLinksItemMethod {
...
impl fmt::Display for CreateFolderFileManagerResponseLinksItemMethod {
