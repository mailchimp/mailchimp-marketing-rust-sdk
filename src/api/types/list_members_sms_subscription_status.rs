...
pub enum ListMembersSmsSubscriptionStatus {
    Subscribed,
    Unsubscribed,
    Nonsubscribed,
    Pending,
...
impl Serialize for ListMembersSmsSubscriptionStatus {
...
impl<'de> Deserialize<'de> for ListMembersSmsSubscriptionStatus {
...
impl fmt::Display for ListMembersSmsSubscriptionStatus {
