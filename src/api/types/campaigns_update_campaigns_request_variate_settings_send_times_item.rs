...
#[serde(untagged)]
pub enum UpdateCampaignsRequestVariateSettingsSendTimesItem {
    DateTime(#[serde(with = "crate::core::flexible_datetime::offset")] DateTime<FixedOffset>),

    String(String),
}

impl UpdateCampaignsRequestVariateSettingsSendTimesItem {
...
impl fmt::Display for UpdateCampaignsRequestVariateSettingsSendTimesItem {
