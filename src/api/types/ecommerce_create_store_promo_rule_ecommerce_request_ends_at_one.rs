...
pub enum CreateStorePromoRuleEcommerceRequestEndsAtOne {
    Empty,
    Zero0000,
    Zero0000000000,
...
impl Serialize for CreateStorePromoRuleEcommerceRequestEndsAtOne {
...
impl<'de> Deserialize<'de> for CreateStorePromoRuleEcommerceRequestEndsAtOne {
...
impl fmt::Display for CreateStorePromoRuleEcommerceRequestEndsAtOne {
