...
pub struct CampaignsVariateSettingsCombinationsItem {
...
impl CampaignsVariateSettingsCombinationsItem {
    pub fn builder() -> CampaignsVariateSettingsCombinationsItemBuilder {
        <CampaignsVariateSettingsCombinationsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CampaignsVariateSettingsCombinationsItemBuilder {
...
impl CampaignsVariateSettingsCombinationsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`CampaignsVariateSettingsCombinationsItem`].
    pub fn build(self) -> Result<CampaignsVariateSettingsCombinationsItem, BuildError> {
        Ok(CampaignsVariateSettingsCombinationsItem {
