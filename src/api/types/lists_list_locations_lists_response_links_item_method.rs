...
pub enum ListLocationsListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListLocationsListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListLocationsListsResponseLinksItemMethod {
...
impl fmt::Display for ListLocationsListsResponseLinksItemMethod {
