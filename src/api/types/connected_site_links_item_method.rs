...
pub enum ConnectedSiteLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ConnectedSiteLinksItemMethod {
...
impl<'de> Deserialize<'de> for ConnectedSiteLinksItemMethod {
...
impl fmt::Display for ConnectedSiteLinksItemMethod {
