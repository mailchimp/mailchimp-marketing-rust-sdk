...
pub enum ListStoresEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoresEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoresEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListStoresEcommerceResponseLinksItemMethod {
