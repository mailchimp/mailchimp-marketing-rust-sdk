...
pub enum ListsSegmentsMembersLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListsSegmentsMembersLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListsSegmentsMembersLinksItemMethod {
...
impl fmt::Display for ListsSegmentsMembersLinksItemMethod {
