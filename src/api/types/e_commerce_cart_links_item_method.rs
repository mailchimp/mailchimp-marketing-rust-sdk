...
pub enum ECommerceCartLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommerceCartLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommerceCartLinksItemMethod {
...
impl fmt::Display for ECommerceCartLinksItemMethod {
