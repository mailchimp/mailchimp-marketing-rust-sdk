...
pub enum ECommercePromoRuleLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommercePromoRuleLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommercePromoRuleLinksItemMethod {
...
impl fmt::Display for ECommercePromoRuleLinksItemMethod {
