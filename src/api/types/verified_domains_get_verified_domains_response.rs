...
pub struct GetVerifiedDomainsResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<GetVerifiedDomainsResponseStatus>,
...
impl GetVerifiedDomainsResponse {
    pub fn builder() -> GetVerifiedDomainsResponseBuilder {
        <GetVerifiedDomainsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetVerifiedDomainsResponseBuilder {
    authenticated: Option<bool>,
    domain: Option<String>,
    is_free_email_provider: Option<bool>,
    status: Option<GetVerifiedDomainsResponseStatus>,
    verification_email: Option<String>,
    verification_sent: Option<DateTime<FixedOffset>>,
    verified: Option<bool>,
}

impl GetVerifiedDomainsResponseBuilder {
    ...
    pub fn status(mut self, value: GetVerifiedDomainsResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`GetVerifiedDomainsResponse`].
    pub fn build(self) -> Result<GetVerifiedDomainsResponse, BuildError> {
        Ok(GetVerifiedDomainsResponse {
