...
pub enum ListTemplateFoldersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListTemplateFoldersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListTemplateFoldersResponseLinksItemMethod {
...
impl fmt::Display for ListTemplateFoldersResponseLinksItemMethod {
