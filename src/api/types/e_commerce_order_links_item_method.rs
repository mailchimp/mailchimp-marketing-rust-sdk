...
pub enum ECommerceOrderLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommerceOrderLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommerceOrderLinksItemMethod {
...
impl fmt::Display for ECommerceOrderLinksItemMethod {
