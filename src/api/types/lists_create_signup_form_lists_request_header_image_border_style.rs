...
pub enum CreateSignupFormListsRequestHeaderImageBorderStyle {
    None,
    Solid,
    Dotted,
    Dashed,
...
impl Serialize for CreateSignupFormListsRequestHeaderImageBorderStyle {
...
impl<'de> Deserialize<'de> for CreateSignupFormListsRequestHeaderImageBorderStyle {
...
impl fmt::Display for CreateSignupFormListsRequestHeaderImageBorderStyle {
