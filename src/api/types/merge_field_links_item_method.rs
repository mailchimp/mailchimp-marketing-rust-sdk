...
pub enum MergeFieldLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for MergeFieldLinksItemMethod {
...
impl<'de> Deserialize<'de> for MergeFieldLinksItemMethod {
...
impl fmt::Display for MergeFieldLinksItemMethod {
