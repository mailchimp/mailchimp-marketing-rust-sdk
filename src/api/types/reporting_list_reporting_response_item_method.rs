...
pub enum ListReportingResponseItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListReportingResponseItemMethod {
...
impl<'de> Deserialize<'de> for ListReportingResponseItemMethod {
...
impl fmt::Display for ListReportingResponseItemMethod {
