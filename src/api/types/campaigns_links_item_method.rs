...
pub enum CampaignsLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CampaignsLinksItemMethod {
...
impl<'de> Deserialize<'de> for CampaignsLinksItemMethod {
...
impl fmt::Display for CampaignsLinksItemMethod {
