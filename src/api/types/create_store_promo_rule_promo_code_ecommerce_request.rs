...
pub struct CreateStorePromoRulePromoCodeEcommerceRequest {
...
impl CreateStorePromoRulePromoCodeEcommerceRequest {
    pub fn builder() -> CreateStorePromoRulePromoCodeEcommerceRequestBuilder {
        <CreateStorePromoRulePromoCodeEcommerceRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateStorePromoRulePromoCodeEcommerceRequestBuilder {
    code: Option<String>,
...
impl CreateStorePromoRulePromoCodeEcommerceRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateStorePromoRulePromoCodeEcommerceRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`code`](CreateStorePromoRulePromoCodeEcommerceRequestBuilder::code)
    /// - [`id`](CreateStorePromoRulePromoCodeEcommerceRequestBuilder::id)
    /// - [`redemption_url`](CreateStorePromoRulePromoCodeEcommerceRequestBuilder::redemption_url)
    pub fn build(self) -> Result<CreateStorePromoRulePromoCodeEcommerceRequest, BuildError> {
        Ok(CreateStorePromoRulePromoCodeEcommerceRequest {
            ...
            redemption_url: self
                .redemption_url
                .ok_or_else(|| BuildError::missing_field("redemption_url"))?,
