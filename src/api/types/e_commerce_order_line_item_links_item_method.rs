...
pub enum ECommerceOrderLineItemLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommerceOrderLineItemLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommerceOrderLineItemLinksItemMethod {
...
impl fmt::Display for ECommerceOrderLineItemLinksItemMethod {
