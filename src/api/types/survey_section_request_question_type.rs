...
pub enum SurveySectionRequestQuestionType {
    PickOne,
    PickMany,
    Range,
    Text,
...
impl Serialize for SurveySectionRequestQuestionType {
...
impl<'de> Deserialize<'de> for SurveySectionRequestQuestionType {
...
impl fmt::Display for SurveySectionRequestQuestionType {
