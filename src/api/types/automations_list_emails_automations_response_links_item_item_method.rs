...
pub enum ListEmailsAutomationsResponseLinksItemItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEmailsAutomationsResponseLinksItemItemMethod {
...
impl<'de> Deserialize<'de> for ListEmailsAutomationsResponseLinksItemItemMethod {
...
impl fmt::Display for ListEmailsAutomationsResponseLinksItemItemMethod {
