...
pub enum CampaignReportLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CampaignReportLinksItemMethod {
...
impl<'de> Deserialize<'de> for CampaignReportLinksItemMethod {
...
impl fmt::Display for CampaignReportLinksItemMethod {
