...
pub enum ClickDetailReportLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ClickDetailReportLinksItemMethod {
...
impl<'de> Deserialize<'de> for ClickDetailReportLinksItemMethod {
...
impl fmt::Display for ClickDetailReportLinksItemMethod {
