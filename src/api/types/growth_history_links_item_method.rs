...
pub enum GrowthHistoryLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GrowthHistoryLinksItemMethod {
...
impl<'de> Deserialize<'de> for GrowthHistoryLinksItemMethod {
...
impl fmt::Display for GrowthHistoryLinksItemMethod {
