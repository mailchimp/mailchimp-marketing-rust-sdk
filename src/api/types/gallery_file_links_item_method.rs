...
pub enum GalleryFileLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GalleryFileLinksItemMethod {
...
impl<'de> Deserialize<'de> for GalleryFileLinksItemMethod {
...
impl fmt::Display for GalleryFileLinksItemMethod {
