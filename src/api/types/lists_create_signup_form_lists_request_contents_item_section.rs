...
pub enum CreateSignupFormListsRequestContentsItemSection {
    SignupMessage,
    UnsubMessage,
    SignupThankYouTitle,
...
impl Serialize for CreateSignupFormListsRequestContentsItemSection {
...
impl<'de> Deserialize<'de> for CreateSignupFormListsRequestContentsItemSection {
...
impl fmt::Display for CreateSignupFormListsRequestContentsItemSection {
