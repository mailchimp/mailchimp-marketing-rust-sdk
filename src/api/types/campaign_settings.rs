...
impl CampaignSettings {
    pub fn builder() -> CampaignSettingsBuilder {
        <CampaignSettingsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CampaignSettingsBuilder {
...
impl CampaignSettingsBuilder {
    ...
    /// Consumes the builder and constructs a [`CampaignSettings`].
    pub fn build(self) -> Result<CampaignSettings, BuildError> {
        Ok(CampaignSettings {
