...
pub enum BatchSubscribeOrUnsubscribeListsRequestMembersItemStatusIfNew {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for BatchSubscribeOrUnsubscribeListsRequestMembersItemStatusIfNew {
...
impl<'de> Deserialize<'de> for BatchSubscribeOrUnsubscribeListsRequestMembersItemStatusIfNew {
...
impl fmt::Display for BatchSubscribeOrUnsubscribeListsRequestMembersItemStatusIfNew {
