...
pub enum ListBatchWebhooksResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListBatchWebhooksResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListBatchWebhooksResponseLinksItemMethod {
...
impl fmt::Display for ListBatchWebhooksResponseLinksItemMethod {
