...
pub enum GetFolderFileManagerResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GetFolderFileManagerResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for GetFolderFileManagerResponseLinksItemMethod {
...
impl fmt::Display for GetFolderFileManagerResponseLinksItemMethod {
