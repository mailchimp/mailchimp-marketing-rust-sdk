...
impl MergeFieldOptions {
    pub fn builder() -> MergeFieldOptionsBuilder {
        <MergeFieldOptionsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct MergeFieldOptionsBuilder {
...
impl MergeFieldOptionsBuilder {
    ...
    /// Consumes the builder and constructs a [`MergeFieldOptions`].
    pub fn build(self) -> Result<MergeFieldOptions, BuildError> {
        Ok(MergeFieldOptions {
