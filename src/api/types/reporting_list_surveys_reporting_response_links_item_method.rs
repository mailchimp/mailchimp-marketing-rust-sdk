...
pub enum ListSurveysReportingResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSurveysReportingResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSurveysReportingResponseLinksItemMethod {
...
impl fmt::Display for ListSurveysReportingResponseLinksItemMethod {
