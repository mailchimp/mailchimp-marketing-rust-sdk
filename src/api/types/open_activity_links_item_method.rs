...
pub enum OpenActivityLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for OpenActivityLinksItemMethod {
...
impl<'de> Deserialize<'de> for OpenActivityLinksItemMethod {
...
impl fmt::Display for OpenActivityLinksItemMethod {
