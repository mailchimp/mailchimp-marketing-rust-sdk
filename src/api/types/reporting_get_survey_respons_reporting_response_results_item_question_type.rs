...
pub enum GetSurveyResponsReportingResponseResultsItemQuestionType {
    PickOne,
    PickMany,
    Range,
    Text,
...
impl Serialize for GetSurveyResponsReportingResponseResultsItemQuestionType {
...
impl<'de> Deserialize<'de> for GetSurveyResponsReportingResponseResultsItemQuestionType {
...
impl fmt::Display for GetSurveyResponsReportingResponseResultsItemQuestionType {
