...
pub enum ListStoreOrdersEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreOrdersEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreOrdersEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListStoreOrdersEcommerceResponseLinksItemMethod {
