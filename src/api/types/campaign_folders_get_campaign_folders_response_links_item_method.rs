...
pub enum GetCampaignFoldersResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for GetCampaignFoldersResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for GetCampaignFoldersResponseLinksItemMethod {
...
impl fmt::Display for GetCampaignFoldersResponseLinksItemMethod {
