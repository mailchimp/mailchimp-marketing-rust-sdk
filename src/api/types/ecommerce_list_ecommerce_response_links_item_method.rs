...
pub enum ListEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListEcommerceResponseLinksItemMethod {
