...
pub enum ListSurveyResponsesReportingResponseResponsesItemContactStatus {
    Subscribed,
    Unsubscribed,
    NonSubscribed,
    Cleaned,
...
impl Serialize for ListSurveyResponsesReportingResponseResponsesItemContactStatus {
...
impl<'de> Deserialize<'de> for ListSurveyResponsesReportingResponseResponsesItemContactStatus {
...
impl fmt::Display for ListSurveyResponsesReportingResponseResponsesItemContactStatus {
