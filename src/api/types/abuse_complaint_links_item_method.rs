...
pub enum AbuseComplaintLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for AbuseComplaintLinksItemMethod {
...
impl<'de> Deserialize<'de> for AbuseComplaintLinksItemMethod {
...
impl fmt::Display for AbuseComplaintLinksItemMethod {
