...
pub enum UpdateStorePromoRuleEcommerceRequestEndsAtOne {
    Empty,
    Zero0000,
    Zero0000000000,
...
impl Serialize for UpdateStorePromoRuleEcommerceRequestEndsAtOne {
...
impl<'de> Deserialize<'de> for UpdateStorePromoRuleEcommerceRequestEndsAtOne {
...
impl fmt::Display for UpdateStorePromoRuleEcommerceRequestEndsAtOne {
