...
pub enum ListAbuseReportsListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAbuseReportsListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAbuseReportsListsResponseLinksItemMethod {
...
impl fmt::Display for ListAbuseReportsListsResponseLinksItemMethod {
