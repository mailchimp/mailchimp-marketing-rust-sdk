...
pub enum ListSentToReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSentToReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSentToReportsResponseLinksItemMethod {
...
impl fmt::Display for ListSentToReportsResponseLinksItemMethod {
