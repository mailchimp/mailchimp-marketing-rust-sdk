...
pub struct ListEcommerceProductActivityReportsResponseProductsItem {
...
impl ListEcommerceProductActivityReportsResponseProductsItem {
    pub fn builder() -> ListEcommerceProductActivityReportsResponseProductsItemBuilder {
        <ListEcommerceProductActivityReportsResponseProductsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListEcommerceProductActivityReportsResponseProductsItemBuilder {
...
impl ListEcommerceProductActivityReportsResponseProductsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`ListEcommerceProductActivityReportsResponseProductsItem`].
    pub fn build(
        self,
    ) -> Result<ListEcommerceProductActivityReportsResponseProductsItem, BuildError> {
        Ok(ListEcommerceProductActivityReportsResponseProductsItem {
