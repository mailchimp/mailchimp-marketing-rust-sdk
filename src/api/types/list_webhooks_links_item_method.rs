...
pub enum ListWebhooksLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListWebhooksLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListWebhooksLinksItemMethod {
...
impl fmt::Display for ListWebhooksLinksItemMethod {
