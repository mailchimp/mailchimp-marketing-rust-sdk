...
pub enum ListSearchCampaignsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSearchCampaignsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSearchCampaignsResponseLinksItemMethod {
...
impl fmt::Display for ListSearchCampaignsResponseLinksItemMethod {
