...
pub struct GetSurveyResponsReportingResponseContact {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<GetSurveyResponsReportingResponseContactStatus>,
}

impl GetSurveyResponsReportingResponseContact {
    pub fn builder() -> GetSurveyResponsReportingResponseContactBuilder {
        <GetSurveyResponsReportingResponseContactBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetSurveyResponsReportingResponseContactBuilder {
    ...
    phone: Option<String>,
    status: Option<GetSurveyResponsReportingResponseContactStatus>,
}

impl GetSurveyResponsReportingResponseContactBuilder {
    ...
    pub fn status(mut self, value: GetSurveyResponsReportingResponseContactStatus) -> Self {
        self.status = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`GetSurveyResponsReportingResponseContact`].
    pub fn build(self) -> Result<GetSurveyResponsReportingResponseContact, BuildError> {
        Ok(GetSurveyResponsReportingResponseContact {
