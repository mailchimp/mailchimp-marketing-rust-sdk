...
pub enum ListBatchesResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListBatchesResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListBatchesResponseLinksItemMethod {
...
impl fmt::Display for ListBatchesResponseLinksItemMethod {
