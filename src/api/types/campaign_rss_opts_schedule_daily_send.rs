...
pub struct CampaignRssOptsScheduleDailySend {
...
impl CampaignRssOptsScheduleDailySend {
    pub fn builder() -> CampaignRssOptsScheduleDailySendBuilder {
        <CampaignRssOptsScheduleDailySendBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CampaignRssOptsScheduleDailySendBuilder {
    friday: Option<bool>,
    monday: Option<bool>,
...
impl CampaignRssOptsScheduleDailySendBuilder {
    ...
    /// Consumes the builder and constructs a [`CampaignRssOptsScheduleDailySend`].
    pub fn build(self) -> Result<CampaignRssOptsScheduleDailySend, BuildError> {
        Ok(CampaignRssOptsScheduleDailySend {
            friday: self.friday,
            monday: self.monday,
