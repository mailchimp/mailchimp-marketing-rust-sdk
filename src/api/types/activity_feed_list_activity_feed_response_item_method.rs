...
pub enum ListActivityFeedResponseItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListActivityFeedResponseItemMethod {
...
impl<'de> Deserialize<'de> for ListActivityFeedResponseItemMethod {
...
impl fmt::Display for ListActivityFeedResponseItemMethod {
