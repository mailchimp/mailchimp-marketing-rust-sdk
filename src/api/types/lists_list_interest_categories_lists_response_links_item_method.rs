...
pub enum ListInterestCategoriesListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListInterestCategoriesListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListInterestCategoriesListsResponseLinksItemMethod {
...
impl fmt::Display for ListInterestCategoriesListsResponseLinksItemMethod {
