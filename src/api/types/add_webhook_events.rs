...
impl AddWebhookEvents {
    pub fn builder() -> AddWebhookEventsBuilder {
        <AddWebhookEventsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AddWebhookEventsBuilder {
...
impl AddWebhookEventsBuilder {
    ...
    /// Consumes the builder and constructs a [`AddWebhookEvents`].
    pub fn build(self) -> Result<AddWebhookEvents, BuildError> {
        Ok(AddWebhookEvents {
