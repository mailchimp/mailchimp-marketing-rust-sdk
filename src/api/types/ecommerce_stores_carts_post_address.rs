...
pub struct EcommerceStoresCartsPostAddress {
...
impl EcommerceStoresCartsPostAddress {
    pub fn builder() -> EcommerceStoresCartsPostAddressBuilder {
        <EcommerceStoresCartsPostAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct EcommerceStoresCartsPostAddressBuilder {
...
impl EcommerceStoresCartsPostAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`EcommerceStoresCartsPostAddress`].
    pub fn build(self) -> Result<EcommerceStoresCartsPostAddress, BuildError> {
        Ok(EcommerceStoresCartsPostAddress {
