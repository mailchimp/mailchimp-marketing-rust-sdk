...
pub enum UpdateMemberListsRequestStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for UpdateMemberListsRequestStatus {
...
impl<'de> Deserialize<'de> for UpdateMemberListsRequestStatus {
...
impl fmt::Display for UpdateMemberListsRequestStatus {
