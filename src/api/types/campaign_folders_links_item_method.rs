...
pub enum CampaignFoldersLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for CampaignFoldersLinksItemMethod {
...
impl<'de> Deserialize<'de> for CampaignFoldersLinksItemMethod {
...
impl fmt::Display for CampaignFoldersLinksItemMethod {
