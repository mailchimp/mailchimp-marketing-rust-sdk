...
pub enum ListStoreProductsEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStoreProductsEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStoreProductsEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListStoreProductsEcommerceResponseLinksItemMethod {
