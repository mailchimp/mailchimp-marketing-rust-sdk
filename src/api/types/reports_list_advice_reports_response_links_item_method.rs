...
pub enum ListAdviceReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAdviceReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAdviceReportsResponseLinksItemMethod {
...
impl fmt::Display for ListAdviceReportsResponseLinksItemMethod {
