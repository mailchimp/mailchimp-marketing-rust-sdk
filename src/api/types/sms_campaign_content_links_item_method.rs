...
pub enum SmsCampaignContentLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for SmsCampaignContentLinksItemMethod {
...
impl<'de> Deserialize<'de> for SmsCampaignContentLinksItemMethod {
...
impl fmt::Display for SmsCampaignContentLinksItemMethod {
