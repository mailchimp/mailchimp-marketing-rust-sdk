...
pub enum ListOpenDetailsReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListOpenDetailsReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListOpenDetailsReportsResponseLinksItemMethod {
...
impl fmt::Display for ListOpenDetailsReportsResponseLinksItemMethod {
