...
pub enum SegmentTypeItemEmailAddressOp {
    Is,
    Not,
    Contains,
    Notcontain,
...
impl Serialize for SegmentTypeItemEmailAddressOp {
...
impl<'de> Deserialize<'de> for SegmentTypeItemEmailAddressOp {
...
impl fmt::Display for SegmentTypeItemEmailAddressOp {
