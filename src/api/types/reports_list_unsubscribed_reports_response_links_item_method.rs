...
pub enum ListUnsubscribedReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListUnsubscribedReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListUnsubscribedReportsResponseLinksItemMethod {
...
impl fmt::Display for ListUnsubscribedReportsResponseLinksItemMethod {
