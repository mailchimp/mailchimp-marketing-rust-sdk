...
pub enum ListLandingPagesReportingResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListLandingPagesReportingResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListLandingPagesReportingResponseLinksItemMethod {
...
impl fmt::Display for ListLandingPagesReportingResponseLinksItemMethod {
