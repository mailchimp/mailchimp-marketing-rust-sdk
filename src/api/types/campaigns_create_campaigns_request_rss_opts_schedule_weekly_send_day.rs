...
pub enum CreateCampaignsRequestRssOptsScheduleWeeklySendDay {
    Sunday,
    Monday,
    Tuesday,
    Wednesday,
...
impl Serialize for CreateCampaignsRequestRssOptsScheduleWeeklySendDay {
...
impl<'de> Deserialize<'de> for CreateCampaignsRequestRssOptsScheduleWeeklySendDay {
...
impl fmt::Display for CreateCampaignsRequestRssOptsScheduleWeeklySendDay {
