...
pub enum ListChimpChatterActivityFeedResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListChimpChatterActivityFeedResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListChimpChatterActivityFeedResponseLinksItemMethod {
...
impl fmt::Display for ListChimpChatterActivityFeedResponseLinksItemMethod {
