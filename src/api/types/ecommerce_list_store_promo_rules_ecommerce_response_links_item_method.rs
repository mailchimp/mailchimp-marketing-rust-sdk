...
pub enum ListStorePromoRulesEcommerceResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListStorePromoRulesEcommerceResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListStorePromoRulesEcommerceResponseLinksItemMethod {
...
impl fmt::Display for ListStorePromoRulesEcommerceResponseLinksItemMethod {
