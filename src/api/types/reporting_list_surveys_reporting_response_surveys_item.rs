...
pub struct ListSurveysReportingResponseSurveysItem {
    ...
    /// The survey's status.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListSurveysReportingResponseSurveysItemStatus>,
...
impl ListSurveysReportingResponseSurveysItem {
    pub fn builder() -> ListSurveysReportingResponseSurveysItemBuilder {
        <ListSurveysReportingResponseSurveysItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListSurveysReportingResponseSurveysItemBuilder {
    created_at: Option<DateTime<FixedOffset>>,
    id: Option<String>,
    list_id: Option<String>,
    list_name: Option<String>,
    published_at: Option<DateTime<FixedOffset>>,
    status: Option<ListSurveysReportingResponseSurveysItemStatus>,
    title: Option<String>,
...
impl ListSurveysReportingResponseSurveysItemBuilder {
    ...
    pub fn status(mut self, value: ListSurveysReportingResponseSurveysItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListSurveysReportingResponseSurveysItem`].
    pub fn build(self) -> Result<ListSurveysReportingResponseSurveysItem, BuildError> {
        Ok(ListSurveysReportingResponseSurveysItem {
