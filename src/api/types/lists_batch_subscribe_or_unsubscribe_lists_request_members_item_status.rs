...
pub enum BatchSubscribeOrUnsubscribeListsRequestMembersItemStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for BatchSubscribeOrUnsubscribeListsRequestMembersItemStatus {
...
impl<'de> Deserialize<'de> for BatchSubscribeOrUnsubscribeListsRequestMembersItemStatus {
...
impl fmt::Display for BatchSubscribeOrUnsubscribeListsRequestMembersItemStatus {
