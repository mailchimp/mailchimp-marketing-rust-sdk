...
pub enum ListSendChecklistCampaignsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSendChecklistCampaignsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSendChecklistCampaignsResponseLinksItemMethod {
...
impl fmt::Display for ListSendChecklistCampaignsResponseLinksItemMethod {
