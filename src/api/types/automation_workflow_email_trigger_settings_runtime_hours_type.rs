...
pub enum AutomationWorkflowEmailTriggerSettingsRuntimeHoursType {
    SendAsap,
    SendBetween,
    SendAt,
...
impl Serialize for AutomationWorkflowEmailTriggerSettingsRuntimeHoursType {
...
impl<'de> Deserialize<'de> for AutomationWorkflowEmailTriggerSettingsRuntimeHoursType {
...
impl fmt::Display for AutomationWorkflowEmailTriggerSettingsRuntimeHoursType {
