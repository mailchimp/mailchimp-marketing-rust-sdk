...
pub enum UpsertMemberListsRequestStatus {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for UpsertMemberListsRequestStatus {
...
impl<'de> Deserialize<'de> for UpsertMemberListsRequestStatus {
...
impl fmt::Display for UpsertMemberListsRequestStatus {
