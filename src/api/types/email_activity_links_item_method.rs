...
pub enum EmailActivityLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for EmailActivityLinksItemMethod {
...
impl<'de> Deserialize<'de> for EmailActivityLinksItemMethod {
...
impl fmt::Display for EmailActivityLinksItemMethod {
