...
pub enum ConversationMessageLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ConversationMessageLinksItemMethod {
...
impl<'de> Deserialize<'de> for ConversationMessageLinksItemMethod {
...
impl fmt::Display for ConversationMessageLinksItemMethod {
