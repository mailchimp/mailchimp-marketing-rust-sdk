...
pub enum ListSegmentMembersListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSegmentMembersListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSegmentMembersListsResponseLinksItemMethod {
...
impl fmt::Display for ListSegmentMembersListsResponseLinksItemMethod {
