...
pub enum ECommerceCustomerLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ECommerceCustomerLinksItemMethod {
...
impl<'de> Deserialize<'de> for ECommerceCustomerLinksItemMethod {
...
impl fmt::Display for ECommerceCustomerLinksItemMethod {
