...
pub enum ListLocationsReportsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListLocationsReportsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListLocationsReportsResponseLinksItemMethod {
...
impl fmt::Display for ListLocationsReportsResponseLinksItemMethod {
