...
pub enum BatchAddOrRemoveMembersListsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for BatchAddOrRemoveMembersListsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for BatchAddOrRemoveMembersListsResponseLinksItemMethod {
...
impl fmt::Display for BatchAddOrRemoveMembersListsResponseLinksItemMethod {
