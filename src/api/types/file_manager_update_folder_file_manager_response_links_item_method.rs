...
pub enum UpdateFolderFileManagerResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for UpdateFolderFileManagerResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for UpdateFolderFileManagerResponseLinksItemMethod {
...
impl fmt::Display for UpdateFolderFileManagerResponseLinksItemMethod {
