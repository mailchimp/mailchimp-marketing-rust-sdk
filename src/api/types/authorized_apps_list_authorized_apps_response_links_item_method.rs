...
pub enum ListAuthorizedAppsResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListAuthorizedAppsResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListAuthorizedAppsResponseLinksItemMethod {
...
impl fmt::Display for ListAuthorizedAppsResponseLinksItemMethod {
