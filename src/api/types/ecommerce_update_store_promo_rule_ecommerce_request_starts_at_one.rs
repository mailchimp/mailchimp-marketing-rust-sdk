...
pub enum UpdateStorePromoRuleEcommerceRequestStartsAtOne {
    Empty,
    Zero0000,
    Zero0000000000,
...
impl Serialize for UpdateStorePromoRuleEcommerceRequestStartsAtOne {
...
impl<'de> Deserialize<'de> for UpdateStorePromoRuleEcommerceRequestStartsAtOne {
...
impl fmt::Display for UpdateStorePromoRuleEcommerceRequestStartsAtOne {
