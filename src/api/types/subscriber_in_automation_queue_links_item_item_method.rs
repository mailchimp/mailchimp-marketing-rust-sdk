...
pub enum SubscriberInAutomationQueueLinksItemItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for SubscriberInAutomationQueueLinksItemItemMethod {
...
impl<'de> Deserialize<'de> for SubscriberInAutomationQueueLinksItemItemMethod {
...
impl fmt::Display for SubscriberInAutomationQueueLinksItemItemMethod {
