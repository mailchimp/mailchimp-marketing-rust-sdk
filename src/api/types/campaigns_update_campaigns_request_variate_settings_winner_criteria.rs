...
pub enum UpdateCampaignsRequestVariateSettingsWinnerCriteria {
    Opens,
    Clicks,
    Manual,
    TotalRevenue,
...
impl Serialize for UpdateCampaignsRequestVariateSettingsWinnerCriteria {
...
impl<'de> Deserialize<'de> for UpdateCampaignsRequestVariateSettingsWinnerCriteria {
...
impl fmt::Display for UpdateCampaignsRequestVariateSettingsWinnerCriteria {
