...
pub enum SentToLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for SentToLinksItemMethod {
...
impl<'de> Deserialize<'de> for SentToLinksItemMethod {
...
impl fmt::Display for SentToLinksItemMethod {
