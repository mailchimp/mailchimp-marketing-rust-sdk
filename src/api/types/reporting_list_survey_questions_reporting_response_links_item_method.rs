...
pub enum ListSurveyQuestionsReportingResponseLinksItemMethod {
    Get,
    Post,
    Put,
    Patch,
...
impl Serialize for ListSurveyQuestionsReportingResponseLinksItemMethod {
...
impl<'de> Deserialize<'de> for ListSurveyQuestionsReportingResponseLinksItemMethod {
...
impl fmt::Display for ListSurveyQuestionsReportingResponseLinksItemMethod {
