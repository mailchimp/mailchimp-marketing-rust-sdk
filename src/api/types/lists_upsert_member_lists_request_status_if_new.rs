...
pub enum UpsertMemberListsRequestStatusIfNew {
    Subscribed,
    Unsubscribed,
    Cleaned,
    Pending,
...
impl Serialize for UpsertMemberListsRequestStatusIfNew {
...
impl<'de> Deserialize<'de> for UpsertMemberListsRequestStatusIfNew {
...
impl fmt::Display for UpsertMemberListsRequestStatusIfNew {
